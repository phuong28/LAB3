...
<main id="main" class="main">
    ...
    <div class="container-fluid pt-4 px-4">
        ...
        <?php
                        ...
                        $product = $this_product->find($id)->hydrate();
                    ?>
            <div class="col-12">
                ...
                <?php if (Flash::has('create_success')): ?>
                                    ...
                                    <?php endif ?>
                    <form action="<?php echo url("admin/products/update", ['products_id' => $id]) ?>" method="POST"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <select style="width: 82%;" class="form-select col-sm-10"  name="size" id="size">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="addtional_information" name="addtional_information" value="<?php echo $product->addtional_information ?>">
                            </div>
                            <p class="text-danger">
